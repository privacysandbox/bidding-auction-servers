...
output "app_mesh_name" {
  ...
  value       = aws_appmesh_mesh.app_mesh.name
}

output "app_mesh_id" {
  description = "The ID of the app mesh."
  value       = aws_appmesh_mesh.app_mesh.id
}

output "cloud_map_private_dns_namespace_id" {
  description = "ID of the cloud map namespace"
  value       = aws_service_discovery_private_dns_namespace.cloud_map_private_dns_namespace.id
}

output "cloud_map_private_dns_namespace_name" {
  description = "Name of the cloud map namespace"
  value       = aws_service_discovery_private_dns_namespace.cloud_map_private_dns_namespace.name
}
