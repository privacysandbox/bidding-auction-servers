...
output "acmpca_certificate_authority_arn" {
  description = "ARN of the AWS Certificate manager private certificate authority created here."
  value       = var.use_tls_with_mesh ? aws_acmpca_certificate_authority.acmpca_certificate_authority[0].arn : ""
}
