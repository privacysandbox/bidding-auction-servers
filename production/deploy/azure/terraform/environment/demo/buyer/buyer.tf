locals {
  azure_project_id = "" # Example: "your-gcp-project-123"
  environment    = "" # Example: "testing"
  image_repo     = "" # Example: "us-docker.pkg.dev/your-azure-project-123/services"
...
module "buyer" {
  ...
  azure_project_id       = local.azure_project_id
