...
#ifndef SERVICES_BIDDING_SERVICE_BIDDING_V8_CONSTANTS_H_
#define SERVICES_BIDDING_SERVICE_BIDDING_V8_CONSTANTS_H_
...
// Params related to the UDF to use to generate bids for protected audience
// interest groups.
enum class GenerateBidUdfArgs : std::uint8_t {
  kInterestGroup = 0,
  kAuctionSignals,
  kBuyerSignals,
...
inline constexpr int kNumGenerateProtectedAppSignalsBidUdfArgs = 10;
enum class GenerateProtectedAppSignalsBidUdfArgs : std::uint8_t {
  kAds = 0,
  kAuctionSignals,
  kBuyerSignals,
...
#endif  // SERVICES_BIDDING_SERVICE_BIDDING_V8_CONSTANTS_H_
