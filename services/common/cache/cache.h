...
#ifndef SERVICES_COMMON_CACHE_CACHE_H_
#define SERVICES_COMMON_CACHE_CACHE_H_
...
class Cache : public CacheInterface<KeyT, ValueT> {
 public:
  ...
  explicit Cache(
    ...
    PS_CHECK(executor_ != nullptr, SystemLogContext());
    executor_->Run([this]() {
...
#endif  // SERVICES_COMMON_CACHE_CACHE_H_
