...
#ifndef SERVICES_COMMON_CLIENTS_HTTP_MULTI_CURL_REQUEST_MANAGER_LOCKING_H_
#define SERVICES_COMMON_CLIENTS_HTTP_MULTI_CURL_REQUEST_MANAGER_LOCKING_H_
...
class MultiCurlRequestManagerLocking final {
 public:
  // Initializes the Curl Multi session.
  explicit MultiCurlRequestManagerLocking(
  ...
  ~MultiCurlRequestManagerLocking();
  ...
  // MultiCurlRequestManagerLocking is neither copyable nor movable.
  MultiCurlRequestManagerLocking(const MultiCurlRequestManagerLocking&) =
      delete;
  MultiCurlRequestManagerLocking& operator=(
      const MultiCurlRequestManagerLocking&) = delete;
...
#endif  // SERVICES_COMMON_CLIENTS_HTTP_MULTI_CURL_REQUEST_MANAGER_LOCKING_H_
