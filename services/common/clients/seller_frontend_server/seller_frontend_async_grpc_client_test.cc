...
using ServiceThread =
    MockServerThread<SellerFrontEndServiceMock, Request, Response>;
using ClientConfig = SellerFrontEndServiceClientConfig;
using TestClient = SellerFrontEndGrpcClient;

class SellerFrontEndAsyncGrpcTest : public ::testing::Test {};

TEST_F(SellerFrontEndAsyncGrpcTest, CallsServerWithRequest) {
...
TEST_F(SellerFrontEndAsyncGrpcTest, CallsServerWithMetadata) {
...
TEST_F(SellerFrontEndAsyncGrpcTest, PassesStatusToCallback) {
  auto dummy_service_thread_ = std::make_unique<ServiceThread>(
...
TEST_F(SellerFrontEndAsyncGrpcTest, CallsServerWithTimeout) {
  auto input_request_ptr = std::make_unique<Request>();
  absl::Notification notification;
...
TEST_F(SellerFrontEndAsyncGrpcTest, PassesResponseToCallback) {
