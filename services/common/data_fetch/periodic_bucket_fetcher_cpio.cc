...
PeriodicBucketFetcher::ListBlobsSyncCpio() {
  absl::StatusOr<
      google::cmrt::sdk::blob_storage_service::v1::ListBlobsMetadataResponse>
      result;
  ...
  if (const absl::Status status = ListBlobsMetadataFromResultCpio(
...
void PeriodicBucketFetcher::PeriodicBucketFetchSync() {
  ...
  for (const google::cmrt::sdk::blob_storage_service::v1::BlobMetadata& md :
