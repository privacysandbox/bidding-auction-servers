...
#define PS_LOC                                               \
  privacy_sandbox::bidding_auction_servers::SourceLocation:: \
      DoNotInvokeDirectly(__LINE__, __FILE__)
#define PS_LOC_CURRENT_DEFAULT_ARG \
  = privacy_sandbox::bidding_auction_servers::SourceLocation::current()
